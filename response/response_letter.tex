...
\response{Thank you once more for coordinating the review process of our paper. We hope that we have revised our article in accordance with the responses of the reviewers. We therefore believe we have addressed all three points that the Editor raised as accurately as possible. Briefly, in the revised article:
\begin{itemize}
	\item We provided better a motivation in Section 1.1, we mentioned our contributions more clearly by also citing the related work suggested by Reviewer 1;
	\item We addressed all of the technical details, especially the differences of our work from slot and bit-level synchronization in EPC Gen2 standard;
	\item We solved the misunderstanding about multi-hop CRFID networks by clearly stating that these networks do not exist yet and the focus of our work is current of-the-shelf CRFID and reader platforms.
\end{itemize}	
	
We request the Editor to refer to our respective responses below; in particular \hyperref[R1:1]{[R1:1]}, \hyperref[R1:2]{[R1:2]}, \hyperref[R1:3]{[R1:3]}, \hyperref[R2:1]{[R2:1]} and \hyperref[R3:2]{[R3:2]}. }
...
We would like to emphasize that none of these issues have been addressed and studied so far within the context of CRFIDs. The above discussion has been briefly added to Section 2.2.2.}
